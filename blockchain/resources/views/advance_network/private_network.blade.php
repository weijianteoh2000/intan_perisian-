<div class="container hideElement network_group" id="privateNetworkContainer"
    style="position: fixed;top: 50%;left: 50%; transform: translate(-50%, -50%);">
    <div class="row bgLight round_div">
        <h3 class="mt-3 text-center"> BLOCKCHAIN PRIVATE NETWORK </h3>
        ...
        <div class="col-md-10 offset-md-1 mt-4 public_network text-center">
            ...
            <div class="private_Vline_icon"><i class="fa-solid fa-lock fa-xs" style="margin-top:10px "></i></div>
            <div class="private_Hline"></div>
        ...
        <div class="col-md-10 offset-md-1 mt-5 public_network">
            <p> Private blockchain network is restricted and owned by single entity or organization. Often used by
                enterprises for internal processes.
            </p>
        </div>
