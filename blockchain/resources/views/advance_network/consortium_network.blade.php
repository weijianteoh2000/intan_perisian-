<div class="container hideElement network_group" id="consortiumNetworkContainer"
    style="position: fixed;top: 50%;left: 50%; transform: translate(-50%, -50%);">
    <div class="row bgLight round_div">
        <h3 class="mt-3 text-center"> BLOCKCHAIN CONSORTIUM NETWORK </h3>
            ...
            <div class="network_circle" data-id="1">
                <div class="networkTxt hideElement iconData_1">
                    <p>
                        Node<br>
                        ID: 55j853t9kj874.... <br>
                        Name: 55GETSF4mfoc89... <br>
                        Encode: 55d8d7d78umdf... <br>
                    </p>
                </div>
                <img src="{{ asset('images/mobile.png') }}" alt="" height="30px" style=" margin-top:20px">
                <div class="label-1" style="">Mobile</div>
            </div>
            <div class="Vline_2"></div>
            <div class="Vline_2_icon"><i class="fa-solid fa-user fa-xs"></i></div>
        ...
        <div class="col-md-10 offset-md-1 mt-4 public_network text-center">
            ...
            <div class="private_Hline"></div>
            <div class="private_Vline_icon"><i class="fa-solid fa-user fa-xs" style="margin-top:10px "></i></div>
            <div class="private_Hline"></div>
            ...
            <div class="network_circle" data-id="3">
                ...
                <img src="{{ asset('images/mobile.png') }}" alt="" height="30px" style=" margin-top:20px">
                <div class="label-3" style="top:-10px">Mobile</div>
            </div>
        ...
        <div class="col-md-10 offset-md-1 mt-5 public_network">
            <p> Consortium blockchain network is a hybrid of public and private network which is controlled by a group
                of organizations that work together to maintain the network. Suitable for multiple company works
                together on a shared blockchain network.
            </p>
        </div>
